...
static int nonce_function_test_fail(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {
   ...
   return secp256k1_nonce_function_rfc6979(nonce32, msg32, key32, algo16, data, counter - 1);
}
...
static int nonce_function_test_retry(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {
   ...
   return secp256k1_nonce_function_rfc6979(nonce32, msg32, key32, algo16, data, counter - 5);
}
...
void test_ecdsa_edge_cases(void) {
    ...
    for (t = 0; t < 2; t++) {
        ...
        CHECK(!is_empty_signature(&sig));
        CHECK(secp256k1_ecdsa_sign(ctx, &sig2, msg, key, secp256k1_nonce_function_rfc6979, extra) == 1);
...

    {
        ...
        VG_UNDEF(nonce3,32);
        VG_UNDEF(nonce4,32);
        CHECK(secp256k1_nonce_function_rfc6979(nonce, zeros, zeros, NULL, NULL, 0) == 1);
        VG_CHECK(nonce,32);
        CHECK(secp256k1_nonce_function_rfc6979(nonce2, zeros, zeros, zeros, NULL, 0) == 1);
        VG_CHECK(nonce2,32);
        CHECK(secp256k1_nonce_function_rfc6979(nonce3, zeros, zeros, NULL, (void *)zeros, 0) == 1);
        VG_CHECK(nonce3,32);
        CHECK(secp256k1_nonce_function_rfc6979(nonce4, zeros, zeros, zeros, (void *)zeros, 0) == 1);
        VG_CHECK(nonce4,32);
